...
.. py:currentmodule:: OxfordInstruments.MapRaw.test_MapRawFormat
   :synopsis: Tests for the module :py:mod:`pySpectrumFileFormat.Bruker.MapRaw.MapRawFormat`

.. moduleauthor:: Hendrix Demers <hendrix.demers@mail.mcgill.ca>

Tests for the module :py:mod:`pySpectrumFileFormat.Bruker.MapRaw.MapRawFormat`.
"""
